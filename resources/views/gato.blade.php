...
<div class="row">
  <div class="col-sm-4">
   <!--inicio tarjeta-->
    ...
    <img src="{{url('img/gato1.jpg')}}" class="card-img-top" alt="...">
    <div class="card-body">
...
<!--end tarjeta-->
  ...
  <div class="col-sm-4">
  <div class="card text-white bg-secondary" style="width: 18rem;">
    <img src="{{url('img/gato2.jpg')}}" class="card-img-top" alt="...">
    <div class="card-body">
  ...
  <div class="col-sm-4">
  <div class="card text-white bg-secondary" style="width: 18rem;">
    <img src="{{url('img/gato3.jpg')}}" class="card-img-top" alt="...">
    <div class="card-body">
...
<div class="row">
  <div class="col-sm-4">
   <!--inicio tarjeta-->
    <div class="card text-white bg-secondary" style="width: 18rem;">
    <img src="{{url('img/gato4.jpg')}}" class="card-img-top" alt="...">
    <div class="card-body">
...
<!--end tarjeta-->
  ...
  <div class="col-sm-4">
  <div class="card text-white bg-secondary" style="width: 18rem;">
    <img src="{{url('img/gato6.jpg')}}" class="card-img-top" alt="...">
    <div class="card-body">
  ...
  <div class="col-sm-4">
  <div class="card text-white bg-secondary" style="width: 18rem;">
    <img src="{{url('img/gato5.jpg')}}" class="card-img-top" alt="...">
    <div class="card-body">
